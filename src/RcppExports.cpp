...
RcppExport SEXP _flscuts_computeSparseRowVariances(SEXP jSEXP, SEXP valSEXP, SEXP rmSEXP, SEXP nSEXP) {
BEGIN_RCPP
...
static const R_CallMethodDef CallEntries[] = {
    {"_flscuts_computeSparseRowVariances", (DL_FUNC) &_flscuts_computeSparseRowVariances, 4},
    {NULL, NULL, 0}
};

RcppExport void R_init_flscuts(DllInfo *dll) {
